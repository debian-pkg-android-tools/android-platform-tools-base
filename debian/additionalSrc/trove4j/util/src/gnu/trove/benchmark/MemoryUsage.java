...
public class MemoryUsage {
    ...
    public static void main(String[] args) {
        try {
            ...
            map.compare();
            MemoryComparator imap =
                new MemoryComparator(new TroveIntMapCreator(),
                                     new JavasoftMapCreator(),
                                     "Compare size of IntIntMap implementation: 1,000 int->int mappings measured in bytes");
            imap.compare();

            new MemoryComparator(new Creator() {
                @Override
                public Object create() {
                    ...
                    new JavasoftMapCreator(),
                    "Compare size of TIntObjectMap implementation: 1,000 int->int mappings measured in bytes")
                    .compare();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    static class TroveIntMapCreator implements Creator {
        @Override
        public Object create() {
